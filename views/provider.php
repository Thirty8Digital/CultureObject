<div class="wrap">
	...
	if ( isset( $provider_class ) ) {
		...
		if ( isset( $info['no_options'] ) && $info['no_options'] ) {
			$show_settings = false;
		}
	}
	?>
	...
	<?php
	if ( isset( $provider_class ) && method_exists( $provider_class, 'generate_settings_outside_form_html' ) ) {
		$provider_class->generate_settings_outside_form_html();}
	?>

	<?php
	if ( false && isset( $provider_info ) && $provider_info && ( isset( $provider_info['ajax'] ) && $provider_info['ajax'] ) ) {
		?>
