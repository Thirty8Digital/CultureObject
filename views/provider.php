<div class="wrap">
    ...
    <?php if (false && isset($provider_info) && $provider_info && (isset($provider_info['ajax']) && $provider_info['ajax'])) { //Disable this while we figure out how AJAX will work. ?>
        ...
        <input type="submit" name="perform_ajax_sync" id="perform_ajax_sync" data-sync-key="<?php echo get_site_option('cos_core_sync_key'); ?>" class="button button-primary" value="<?php _e('Perform Sync','culture-object'); ?>">
